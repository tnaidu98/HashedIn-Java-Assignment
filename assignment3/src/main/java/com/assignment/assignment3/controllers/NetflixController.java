...
public class NetflixController {
    ...
    public ResponseEntity<String> addShowDetails(@RequestBody List<ShowDetails> newShowDetailsList) {

        if(newShowDetailsList.isEmpty()){
            return new ResponseEntity<>("No ShowDetails are sent",HttpStatus.OK);
        }
        else{
            return new ResponseEntity<>(netflixService.addShowDetailsToDB(newShowDetailsList),HttpStatus.OK);
        }
    }

    @GetMapping("/getShowDetails")
    public ResponseEntity<List<ShowDetails>> getShowDetails(@RequestParam String dataSource) {

        return new ResponseEntity<>(netflixService.getShowDetails(dataSource),HttpStatus.OK);
